...
import { StatementLedger } from "@/app/[locale]/(app)/dashboard/stores/[id]/statement/statement-ledger";

export default async function FieldCustomerStatementPage({
  params,
  searchParams,
}: {
    ...
    <main className="mx-auto w-full max-w-content space-y-4">
      ...
      >
        <div className="flex items-start gap-2 text-start">
          ...
          <div className="min-w-0">
            <h2 className="text-sm font-semibold text-fg">{t("reports.periodFilters")}</h2>
        ...
        <div className="sticky-form-actions sticky-form-actions-field -mx-3 sm:-mx-4 lg:hidden">
          <button
            type="submit"
            className="btn btn-important w-full"
          >
      ...
      <section className="statement-print space-y-4 rounded-2xl border border-line bg-surface p-4 sm:p-5">
        <header className="flex flex-wrap items-start gap-3 border-b border-line pb-4 text-start">
          <span className="icon-badge icon-badge-md tone-sky print:hidden">
        ...
        <div className="space-y-2">
          <h3 className="text-start text-sm font-semibold text-fg">{t("reports.aging")}</h3>
